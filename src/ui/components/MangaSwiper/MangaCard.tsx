...
const MangaCard: React.FC<MangaCardProps> = ({
  ...
  return (
    <div
      className="swiper-slide manga-swipe mb-4 swiper-slide-active"
      style={{
    ...
    >
      <Link
        href="https://vortexscans.org/series/operat-loveww"
        className="relative inline-flex items-center tap-highlight-transparent outline-none focus-visible:z-10 focus-visible:outline-2 focus-visible:outline-focus focus-visible:outline-offset-2 text-medium no-underline hover:opacity-80 active:opacity-disabled transition-opacity"
        style={{ height: "400px", paddingTop: "70px", color: "white" }}
